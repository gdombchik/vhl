...
class PDER_Admin_VHL{
	...
	function create_menu(){
		...
		$hooks[] = add_menu_page('Create Email Reminder', 'Email Reminder', 'manage_options', 'pogidude-ereminder', array( &$this, 'ereminder_page' ), PDER_ASSETS_VHL . '/images/icon.png' );
	...
	function ereminder_page(){
		...
		echo PDER_Utils_VHL::get_view( $file, $data );
	}
	...
	function process_submissions(){
		...
		if( isset( $_POST['pder-action'] ) && $_POST['pder-action'] == 'add'){
