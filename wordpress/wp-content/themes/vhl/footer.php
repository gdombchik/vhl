...
<div id="footer" class="clearfix">
    ...
    <div id="footer-wrapper" style="color:#ccc;">
<?php /*    
        <div class="grid col-940" style="color:#ccc;">
        
        <div class="grid col-540" style="color:#ccc;">
		<?php if (has_nav_menu('footer-menu', 'responsive')) { ?>
         ...
         <div class="grid col-380 fit" style="color:#ccc;">
 ...
 */
 ?>
        ...
        <div class="grid col-300 copyright" style="color:#ccc;">
            <?php esc_attr_e('&copy;', 'vhl'); ?> <?php _e(date('Y')); ?><a style="color:#ccc;" href="<?php echo home_url('/') ?>" title="<?php echo 'VHL Alliance'; ?>">
                <?php echo ' VHL Alliance'; ?>
            </a>
        </div><!-- end of .copyright -->
        
        <div class="grid col-300 scroll-top" style="color:#ccc;"><a href="#scroll-top" style="color:#ccc;" title="<?php esc_attr_e( 'scroll to top', 'responsive' ); ?>"><?php _e( '&uarr;', 'responsive' ); ?></a></div>
        
        <div class="grid col-300 fit powered" style="color:#ccc;">
            <a style="color:#ccc;" href="<?php echo esc_url(__('http://pbjweb.com/','vhl')); ?>" title="<?php esc_attr_e('PBJ Web', 'vhl'); ?>">
                    <?php printf('Website developed by Ky Inthavong'); ?></a>            
        </div><!-- end .powered -->
